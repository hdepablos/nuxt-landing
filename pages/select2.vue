            ...
            <div class="ibox ">
                ...
                <div class="ibox-content float-e-margins">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label>Cargado con un objeto y el evento Selected</label>
                            <client-only>
                                <v-select v-model="frutaSel" label="text" name="sel2" id="sel2" :options="frutas" @input="getSelectedFruta"/>
                            </client-only>
                        </div>
                        <div class="col-md-4">
                            <label>Select 2 sencillo básico y evento al change</label>
                            <client-only>
                                <v-select name="sel3" id="sel3" :options="options" @input="setSelected" :clearable="false"/>
                            </client-only>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group has-error">
                                <label class="control-label" for="sel5">Select 2 multiple sencillo básico y evento al change</label>
                                <client-only>
                        ...
                        <div class="col-md-4">
                            <div class="form-group has-error">
                                <label class="control-label" for="sel6">Select 2 multiple sencillo básico y evento al change</label>
                                <client-only>
    ...
    export default {
        ...
        methods: {
            setSelected(value) {
                ...
                console.log('Registro seleccionado en el select');
                console.log(value);
            },
